...
This is a standard Next.js App Router project. No environment variables or database are required. The executive summary uses a built-in rule-based engine — no external AI API.
